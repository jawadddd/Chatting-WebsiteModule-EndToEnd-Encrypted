...
#     hex_text = ''.join(hex(ord(char))[2:].upper() for char in text)
#     return hex_text
...
pt = "Hello World!"
pt = "Ahmad jalal is not actually a bad guy!"
key = "AABB09182736CCDD"

# key_length = len(key) * 4  # Assuming each hex digit represents 4 bits

hex_message = string_to_combined_hex(pt)
